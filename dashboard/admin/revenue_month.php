...
<head>
    ...
    <style>
        ...
        .form-card input, .form-card select { width: 100%; padding: 10px 12px; margin-bottom: 18px; border: 1px solid #ccc; border-radius: 6px; transition: all 0.15s; background: #fff; }
        .form-card input:focus, .form-card select:focus { outline: none; border-color: #6c8397; box-shadow: 0 0 6px rgba(108,131,151,0.25); }
        ...
        /* Table */
        #memmonth { width: 100%; border-collapse: collapse; margin-top: 20px; font-size: 14px; }
        #memmonth td, #memmonth th { border: 1px solid #ccc; padding: 8px; text-align: center; }
        #memmonth .no-data { font-size: 14px; font-weight: normal; color: #333; text-align: center; padding: 10px 0; }
    </style>
</head>
            ...
            <div class="content-area">
                <div class="form-card">
                    <form>
                        ...
                        $defaultYear = date('Y');
                        $defaultMonth = date('m');
                        $monthName = date("F", mktime(0, 0, 0, $defaultMonth, 10));
                        ?>
                        <div class="form-grid">
                            <div>
                            ...
                            <div>
                                ...
                                <select name="month" id="smonth">
                                    ...
                                    foreach ($formattedMonthArray as $key => $month) {
                                        $selected = ($key == $defaultMonth) ? 'selected' : '';
                            ...
                            <div style="grid-column: 1 / -1; text-align:center;">
                                <input type="button" class="btn btn-submit" name="search" onclick="showIncome();" value="Search">
                            </div>
                        </div>
                    </form>
            ...
            <script>
              function showIncome(){
                ...
                if(month=="0" || year=="0"){
                  ...
                  xmlhttp.open("GET","income_month.php?mm="+month+"&yy="+year+"&flag=0",true);
                  xmlhttp.send();
                }
              }
            </script>
